...
export const Footer = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Add form logic here (e.g. submit to API or open mailto)
    };
    ...
    return (
        <section className="relative w-full px-5 md:px-[120px] py-16 md:py-20 font-urbanist bg-[#fcfcfc] flex flex-col gap-6">

            {/* ── Top CTA Banner ── */}
            <div className="w-full flex flex-col md:flex-row items-center justify-between p-6 md:p-8 bg-white border border-[#1a1a1a08] rounded-[32px] shadow-[0_16px_20px_0_rgba(0,0,0,0.05)] gap-6">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className="col-span-1 md:col-span-5 bg-[#1A1A1A] rounded-[32px] p-8 md:p-10 flex flex-col justify-between min-h-[420px] md:min-h-[460px] shadow-[0_16px_20px_0_rgba(0,0,0,0.15),inset_0_4px_6px_0_rgba(255,255,255,0.35)]">
                    {/* Links list */}
                    <div className="flex flex-col gap-5">
                        {navLinks.map((link) => (
                            <a
                                key={link.label}
                                href={link.href}
                                className="text-[20px] md:text-[32px] font-semibold text-[#ffffff] hover:text-[#7F7F7F] transition-colors duration-300"
                            >
                                {link.label}
                            </a>
                        ))}
                ...
                <form
                    ...
                    className="col-span-1 md:col-span-7 bg-[#1A1A1A] rounded-[32px] p-8 md:p-10 flex flex-col justify-between gap-6 shadow-[0_16px_20px_0_rgba(0,0,0,0.15),inset_0_4px_6px_0_rgba(255,255,255,0.35)]"
                >
                    <div className="flex flex-col gap-5 w-full">
                        <h4 className="text-[22px] md:text-[32px] font-semibold text-white">
                            Let's Connect
                        </h4>
                        ...
                        <input
                            ...
                            required
                            className="w-full bg-[#FFFFFF12] text-white placeholder-[#ffffff40] border border-[#ffffff10] focus:ring-[#ffffff60] focus:ring-1 outline-none px-5 py-6 rounded-[20px] transition-all text-[15px] font-medium capitalize"
                        />
                        ...
                        <input
                            ...
                            required
                            className="w-full bg-[#FFFFFF12] text-white placeholder-[#ffffff40] border border-[#ffffff10] focus:ring-[#ffffff60] focus:ring-1 outline-none px-5 py-6 rounded-[20px] transition-all text-[15px] font-medium "
                        />
                        ...
                        <textarea
                            ...
                            required
                            className="w-full bg-[#FFFFFF12] text-white placeholder-[#ffffff40] border border-[#ffffff10] focus:ring-[#ffffff60] focus:ring-1 outline-none px-5 py-6 rounded-[20px] transition-all text-[15px] font-medium  resize-none"
                        />
                    </div>
                    ...
                    <button
                        type="submit"
                        className="w-full bg-white text-[#1a1a1a] py-4.5 rounded-full text-base font-semibold select-none transition-all duration-500 ease-in-out shadow-[0_12px_24px_rgba(255,255,255,0.06)] hover:bg-[#FAFAFA] active:scale-[0.99] cursor-pointer text-center text-lg"
                    >
                        Let's Connect
                    </button>
                </form>
            ...
            {/* ── Copyright Bar ── */}
            <div className="w-full bg-[#1A1A1A] rounded-[24px] py-10 px-8 text-center md:text-left">
